...
class MongooseSchema extends mongoose_1.Schema {
    ...
    bindSoftDeletingStaticMethods() {
        ...
        this.statics.softDeleteById = function (_id) {
            return this.findOneAndUpdate({ _id, deleted_at: null }, {
                $set: {
                    deleted_at: new Date(),
                },
            }, { new: true });
        ...
        this.statics.softDelete = function (query) {
            return this.updateMany(Object.assign(Object.assign({}, query), { deleted_at: null }), {
                $set: {
                    deleted_at: new Date(),
                },
            });
        ...
        this.statics.restore = function (query) {
            return this.updateMany(Object.assign(Object.assign({}, query), { deleted_at: { $ne: null } }), {
                $set: {
                    deleted_at: null,
                },
            });
